...
$pdf->Cell(330,6,'REKAPITULASI SURAT PERNYATAAN HUKUM DISIPLIN',0,1,'C',1);
$pdf->Ln(3);
...
include 'koneksi.php';
$data = mysqli_query($konek,"SELECT*FROM pidana AS a JOIN pegawai AS b ON a.nip=b.nip JOIN pangkat AS c ON b.pangkat=c.id_pnkt ORDER BY a.no DESC");
$no =1;
