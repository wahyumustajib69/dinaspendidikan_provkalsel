            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown text-primary">Surat Pernyataan Hukum Disiplin</h3>
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><button type="button" class="btn btn-primary btn-gradient" data-toggle="modal" data-target="#modal-pidana"><i class="fa fa-plus"></i> TAMBAH</button></div>
                  ...
                  if (isset($_SESSION['pesan']) && $_SESSION['pesan'] <> '') {
                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $pk['no'] ?></td>
                          <td><?php echo tgl_indo($pk['tanggal']) ?></td>
                          <td><?php echo $pk['kadin'].' /'.$pk['nip_kadin'] ?></td>
                          <td><?php echo $pk['nama'].' /'.$pk['nip'] ?></td>
                          <td width="18%">
                            <a href="#" id="<?php echo $pk['no'] ?>" class="btn btn-primary btn-gradient btn-xs modal_edit disabled"><i class="fa fa-edit"></i></a>
                            <a class="btn btn-danger btn-gradient btn-xs disabled" onclick="confirm_delete('pidana_del.php?id=<?php echo $pk['no'];?>')"><i class="fa fa-trash"></i></a>
                            <a href="laporan_disiplin?ref=<?php echo $pk['no'] ?>" class="btn btn-xs btn-gradient btn-warning"><i class="fa fa-print"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
