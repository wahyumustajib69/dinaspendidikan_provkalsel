            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInRight text-primary">Data Kenaikan Pangkat & Promosi</h3>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
                      ...
                      <a href="laporan_promosi" target="_blank" class="btn btn-warning btn-gradient"><i class="fa fa-print"></i> REKAP</a>
                    </div>
                  ...
                  <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-header bg-primary" style="border-top-left-radius: 5px;border-top-right-radius: 5px;">
                        ...
                        <h3 class="modal-title">Tambah Kenaikan Pangkat & Promosi</h3>
                      </div>
