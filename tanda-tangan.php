            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInRight text-primary">Tanda Tangan Kepala Dinas</h3>
              ...
              <div class="col-md-12 top-20 padding-0">
                  ...
                  if (isset($_SESSION['pesan']) && $_SESSION['pesan'] <> '') {
                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $pk['ni'] ?></td>
                          <td><?php echo $pk['nma'] ?></td>
                          <td><?php echo $pk['nm_pnkt'].' /'.$pk['ket'] ?></td>
                          <td><?php echo $pk['jbt'] ?></td>
                          <td width="12%">
                            <a href="#" id="<?php echo $pk['ni'] ?>" class="btn btn-primary btn-round btn-xs modal_edit"><i class="fa fa-edit"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="form-group col-md-12"><label class="col-sm-2 control-label text-right">Nama</label>
                              <div class="col-sm-10"><input type="text" name="nma" class="form-control primary" required=""></div>
                          </div>
                          ...
                          <div class="form-group col-md-12"><label class="col-sm-2 control-label text-right">Jabatan</label>
                            <div class="col-sm-10"><textarea name="jbtn" class="form-control primary" required=""></textarea></div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="modal fade" id="ttd-edit"></div>
